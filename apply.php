...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    try {
        ...
        $errorReference = 'APP-' . strtoupper(substr(hash(
            'sha256',
            (string)microtime(true) . ':' . (string)current_account_id()
        ), 0, 8));
        error_log(
        ...
        <form method="post" class="panel-form application-form" novalidate>
            ...
            <section class="application-section">
                ...
                <div class="skin-picker">
                    <div class="field-label-row"><span>Skin nhân vật</span><b>Danh sách skin SA-MP · cuộn để xem thêm</b></div>
